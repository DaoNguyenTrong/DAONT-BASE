...
This project is indexed by GitNexus as **DAONT-BASE** (3361 symbols, 7612 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

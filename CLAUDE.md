...
This project is indexed by GitNexus as **DAONT-BASE** (2592 symbols, 5468 relationships, 189 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

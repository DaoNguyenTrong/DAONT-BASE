...
This project is indexed by GitNexus as **DAONT-BASE** (3334 symbols, 7489 relationships, 191 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **DAONT-BASE** (3576 symbols, 7980 relationships, 198 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
